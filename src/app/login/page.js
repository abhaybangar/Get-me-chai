...
const Login = () => {
    ...
    if (session) {
        return (
            <div className="flex flex-col items-center gap-4 py-14 text-center text-white">
                <h1 className="font-bold text-3xl">You are signed in</h1>
                <p>{session.user?.email}</p>
                <div className="flex gap-3">
                    <Link href="/">
                        <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                            Home
                        </button>
                    </Link>
                    <button type="button" onClick={() => signOut({ callbackUrl: "/" })} className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        Logout
                    </button>
                </div>
            </div>
